...
viga = Viga(bw=160, h=500, fck=30, fyk=500, Msk=17.54, Vsk=32.39,
cobrimento=25, brita=1, dt=5, bitola=8, teta=30)
...
amin = viga.test_min_steelarea()
amax = viga.test_max_steelarea()
